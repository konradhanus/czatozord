...
class Messenger extends Component {
    ...
    return messages.map((message, i) => {
      return message.isHost ? (
        <React.Fragment key={i}>
          <div className="conversation conversation-host">{message.text}</div>
        ...
        <div className="avatar-message-left-client" key={i}>
          <div className="avatar-left">
            <img
              ...
              src="rsc/img_avatar.png"
              alt="Avatar"
              style={{ width: 200 }}
            />
          </div>
          <div className="conversation avatar-left">{message.text}</div>
        </div>
      );
    });
  }
  ...
  render() {
    ...
    return (
      peer.send && (
        <React.Fragment>
          <div className="chat-win">{this.renderMessages(messages)}</div>
          ...
          <div className="msg-send" onKeyPress={e => this.onKeyPress(e)}>
            ...
            <div className="btns-misc">
              ...
              <button
                ...
                title="Prześlij zdjęcie lub wideo"
              >
